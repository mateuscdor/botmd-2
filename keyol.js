...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
            ...
            break
case 'infobot':
await yol.send5ButImg(from, `Hola ${pushname} 🐦\n\nSoy ${botname}, soy un bot de WhatsApp Multi-Device Beta, estoy inspirada en una inteligencia artificial para ayuda\nSi encuentra algún tipo de error o bug, comprenda primero que estoy en version beta, tendre muchísimos errores :(, informe a mi propietario para que se solucione de inmediato\n\n• Version Qr : *Baileys-MD*.\n• Prefix : ( ${prefix} )\n• Tiempo de Servidor : ${runtime(process.uptime())} \n• Fecha del servidor : ${moment.tz('America/Guayaquil').format('DD/MM/YY')}\n•Gracias por preferirme como su bot de confianza, trataré de ayudar en muchas cosas` + '' + lang.infobot(prefix), `© ${footer}`,thumb, [{"urlButton": {"displayText": "Codigo fuente","url": `${sc}`}},{"urlButton": {"displayText": "Api WhatsApp","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "allmenu","id": 'menu'}},{"quickReplyButton": {"displayText": "Ping and Runtime","id": 'ping'}}] )
break
case 'allmenu':
	await yol.send5ButGif(from, `┌── *Info user*\n│» Nombre : ${pushname}\n│» Biografia : No detectada\n│» Numero : ${sender.split("@")[0]}\n│» Wa Api : http://wa.me/${sender.split("@")[0]}\n│» Usuario : ${isCreator ? `Owner ${ownername}` : isPremium ? `Usuario especial ${botname}` : `${botname}`}\n│» Estado : ${isCreator ? 'Owner ( ilimitado)' : isPremium ? 'Premium' : 'free'}\n│» Límite diario : ${isCreator ? 'Owner (ilimitado)' : isPremium ? 'Ilimitado' : (sender, limitharian)}\n│» Límite diario del juego : ${isCreator ? 'Owner (Ilimitado)' : (sender, limitgame)}\n└───────\n\n┌── *Info Bot*\n│» Biblioteca : Baileys Multi Device\n│» Nombre Bot : ${botname}\n│» Creador : ${ownername}\n│» Autor : DikaArdnt.\n│» Usuarios : ${Object.keys(global.db.data.users).length}\n└───────` + '\n' + lang.menu(prefix) , `${footer}`, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "ser premium","id": 'donar'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Sobre mí","id": 'infobot'}}] )
	break
case 'groupmenu':
	await yol.send5ButGif(from, `┌── *Info user*\n│» Nombre : ${pushname}\n│» Biografia : No detectada\n│» Numero : ${sender.split("@")[0]}\n│» Wa Api : http://wa.me/${sender.split("@")[0]}\n│» Usuario : ${isCreator ? `Owner ${ownername}` : isPremium ? `Usuario especial ${botname}` : `${botname}`}\n│» Estado : ${isCreator ? 'Owner ( ilimitado)' : isPremium ? 'Premium' : 'free'}\n│» Límite diario : ${isCreator ? 'Owner (ilimitado)' : isPremium ? 'Ilimitado' : (sender, limitharian)}\n│» Límite diario del juego : ${isCreator ? 'Owner (Ilimitado)' : (sender, limitgame)}\n└───────\n\n┌── *Info Bot*\n│» Biblioteca : Baileys Multi Device\n│» Nombre Bot : ${botname}\n│» Creador : ${ownername}\n│» Autor : DikaArdnt.\n│» Usuarios : ${Object.keys(global.db.data.users).length}\n└───────` + '\n' + lang.group(prefix) , `${footer}`, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "ser premium","id": 'donar'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Sobre mí","id": 'infobot'}}] )
	break
case 'downloadmenu':
	await yol.send5ButGif(from, `┌── *Info user*\n│» Nombre : ${pushname}\n│» Biografia : No detectada\n│» Numero : ${sender.split("@")[0]}\n│» Wa Api : http://wa.me/${sender.split("@")[0]}\n│» Usuario : ${isCreator ? `Owner ${ownername}` : isPremium ? `Usuario especial ${botname}` : `${botname}`}\n│» Estado : ${isCreator ? 'Owner ( ilimitado)' : isPremium ? 'Premium' : 'free'}\n│» Límite diario : ${isCreator ? 'Owner (ilimitado)' : isPremium ? 'Ilimitado' : (sender, limitharian)}\n│» Límite diario del juego : ${isCreator ? 'Owner (Ilimitado)' : (sender, limitgame)}\n└───────\n\n┌── *Info Bot*\n│» Biblioteca : Baileys Multi Device\n│» Nombre Bot : ${botname}\n│» Creador : ${ownername}\n│» Autor : DikaArdnt.\n│» Usuarios : ${Object.keys(global.db.data.users).length}\n└───────` + '\n' + lang.downloads(prefix) , `${footer}`, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "ser premium","id": 'donar'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Sobre mí","id": 'infobot'}}] )
	break
case 'searchmenu':
	await yol.send5ButGif(from, `┌── *Info user*\n│» Nombre : ${pushname}\n│» Biografia : No detectada\n│» Numero : ${sender.split("@")[0]}\n│» Wa Api : http://wa.me/${sender.split("@")[0]}\n│» Usuario : ${isCreator ? `Owner ${ownername}` : isPremium ? `Usuario especial ${botname}` : `${botname}`}\n│» Estado : ${isCreator ? 'Owner ( ilimitado)' : isPremium ? 'Premium' : 'free'}\n│» Límite diario : ${isCreator ? 'Owner (ilimitado)' : isPremium ? 'Ilimitado' : (sender, limitharian)}\n│» Límite diario del juego : ${isCreator ? 'Owner (Ilimitado)' : (sender, limitgame)}\n└───────\n\n┌── *Info Bot*\n│» Biblioteca : Baileys Multi Device\n│» Nombre Bot : ${botname}\n│» Creador : ${ownername}\n│» Autor : DikaArdnt.\n│» Usuarios : ${Object.keys(global.db.data.users).length}\n└───────` + '\n' + lang.search(prefix) , `${footer}`, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "ser premium","id": 'donar'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Sobre mí","id": 'infobot'}}] )
	break
case 'menuanime':
	await yol.send5ButGif(from, `┌── *Info user*\n│» Nombre : ${pushname}\n│» Biografia : No detectada\n│» Numero : ${sender.split("@")[0]}\n│» Wa Api : http://wa.me/${sender.split("@")[0]}\n│» Usuario : ${isCreator ? `Owner ${ownername}` : isPremium ? `Usuario especial ${botname}` : `${botname}`}\n│» Estado : ${isCreator ? 'Owner ( ilimitado)' : isPremium ? 'Premium' : 'free'}\n│» Límite diario : ${isCreator ? 'Owner (ilimitado)' : isPremium ? 'Ilimitado' : (sender, limitharian)}\n│» Límite diario del juego : ${isCreator ? 'Owner (Ilimitado)' : (sender, limitgame)}\n└───────\n\n┌── *Info Bot*\n│» Biblioteca : Baileys Multi Device\n│» Nombre Bot : ${botname}\n│» Creador : ${ownername}\n│» Autor : DikaArdnt.\n│» Usuarios : ${Object.keys(global.db.data.users).length}\n└───────` + '\n' + lang.random(prefix) , `${footer}`, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "ser premium","id": 'donar'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Sobre mí","id": 'infobot'}}] )
	break
case 'logomenu':
	await yol.send5ButGif(from, `┌── *Info user*\n│» Nombre : ${pushname}\n│» Biografia : No detectada\n│» Numero : ${sender.split("@")[0]}\n│» Wa Api : http://wa.me/${sender.split("@")[0]}\n│» Usuario : ${isCreator ? `Owner ${ownername}` : isPremium ? `Usuario especial ${botname}` : `${botname}`}\n│» Estado : ${isCreator ? 'Owner ( ilimitado)' : isPremium ? 'Premium' : 'free'}\n│» Límite diario : ${isCreator ? 'Owner (ilimitado)' : isPremium ? 'Ilimitado' : (sender, limitharian)}\n│» Límite diario del juego : ${isCreator ? 'Owner (Ilimitado)' : (sender, limitgame)}\n└───────\n\n┌── *Info Bot*\n│» Biblioteca : Baileys Multi Device\n│» Nombre Bot : ${botname}\n│» Creador : ${ownername}\n│» Autor : DikaArdnt.\n│» Usuarios : ${Object.keys(global.db.data.users).length}\n└───────` + '\n' + lang.logomaker(prefix) , `${footer}`, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "ser premium","id": 'donar'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Sobre mí","id": 'infobot'}}] )
	break
case 'funmenu':
	await yol.send5ButGif(from, `┌── *Info user*\n│» Nombre : ${pushname}\n│» Biografia : No detectada\n│» Numero : ${sender.split("@")[0]}\n│» Wa Api : http://wa.me/${sender.split("@")[0]}\n│» Usuario : ${isCreator ? `Owner ${ownername}` : isPremium ? `Usuario especial ${botname}` : `${botname}`}\n│» Estado : ${isCreator ? 'Owner ( ilimitado)' : isPremium ? 'Premium' : 'free'}\n│» Límite diario : ${isCreator ? 'Owner (ilimitado)' : isPremium ? 'Ilimitado' : (sender, limitharian)}\n│» Límite diario del juego : ${isCreator ? 'Owner (Ilimitado)' : (sender, limitgame)}\n└───────\n\n┌── *Info Bot*\n│» Biblioteca : Baileys Multi Device\n│» Nombre Bot : ${botname}\n│» Creador : ${ownername}\n│» Autor : DikaArdnt.\n│» Usuarios : ${Object.keys(global.db.data.users).length}\n└───────` + '\n' + lang.funny(prefix) , `${footer}`, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "ser premium","id": 'donar'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Sobre mí","id": 'infobot'}}] )
	break
case 'convertmenu':
	await yol.send5ButGif(from, `┌── *Info user*\n│» Nombre : ${pushname}\n│» Biografia : No detectada\n│» Numero : ${sender.split("@")[0]}\n│» Wa Api : http://wa.me/${sender.split("@")[0]}\n│» Usuario : ${isCreator ? `Owner ${ownername}` : isPremium ? `Usuario especial ${botname}` : `${botname}`}\n│» Estado : ${isCreator ? 'Owner ( ilimitado)' : isPremium ? 'Premium' : 'free'}\n│» Límite diario : ${isCreator ? 'Owner (ilimitado)' : isPremium ? 'Ilimitado' : (sender, limitharian)}\n│» Límite diario del juego : ${isCreator ? 'Owner (Ilimitado)' : (sender, limitgame)}\n└───────\n\n┌── *Info Bot*\n│» Biblioteca : Baileys Multi Device\n│» Nombre Bot : ${botname}\n│» Creador : ${ownername}\n│» Autor : DikaArdnt.\n│» Usuarios : ${Object.keys(global.db.data.users).length}\n└───────` + '\n' + lang.convert(prefix) , `${footer}`, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "ser premium","id": 'donar'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Sobre mí","id": 'infobot'}}] )
	break
case 'mainmenu':
	await yol.send5ButGif(from, `┌── *Info user*\n│» Nombre : ${pushname}\n│» Biografia : No detectada\n│» Numero : ${sender.split("@")[0]}\n│» Wa Api : http://wa.me/${sender.split("@")[0]}\n│» Usuario : ${isCreator ? `Owner ${ownername}` : isPremium ? `Usuario especial ${botname}` : `${botname}`}\n│» Estado : ${isCreator ? 'Owner ( ilimitado)' : isPremium ? 'Premium' : 'free'}\n│» Límite diario : ${isCreator ? 'Owner (ilimitado)' : isPremium ? 'Ilimitado' : (sender, limitharian)}\n│» Límite diario del juego : ${isCreator ? 'Owner (Ilimitado)' : (sender, limitgame)}\n└───────\n\n┌── *Info Bot*\n│» Biblioteca : Baileys Multi Device\n│» Nombre Bot : ${botname}\n│» Creador : ${ownername}\n│» Autor : DikaArdnt.\n│» Usuarios : ${Object.keys(global.db.data.users).length}\n└───────` + '\n' + lang.main(prefix) , `${footer}`, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "ser premium","id": 'donar'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Sobre mí","id": 'infobot'}}] )
	break
case 'databasemenu':
	await yol.send5ButGif(from, `┌── *Info user*\n│» Nombre : ${pushname}\n│» Biografia : No detectada\n│» Numero : ${sender.split("@")[0]}\n│» Wa Api : http://wa.me/${sender.split("@")[0]}\n│» Usuario : ${isCreator ? `Owner ${ownername}` : isPremium ? `Usuario especial ${botname}` : `${botname}`}\n│» Estado : ${isCreator ? 'Owner ( ilimitado)' : isPremium ? 'Premium' : 'free'}\n│» Límite diario : ${isCreator ? 'Owner (ilimitado)' : isPremium ? 'Ilimitado' : (sender, limitharian)}\n│» Límite diario del juego : ${isCreator ? 'Owner (Ilimitado)' : (sender, limitgame)}\n└───────\n\n┌── *Info Bot*\n│» Biblioteca : Baileys Multi Device\n│» Nombre Bot : ${botname}\n│» Creador : ${ownername}\n│» Autor : DikaArdnt.\n│» Usuarios : ${Object.keys(global.db.data.users).length}\n└───────` + '\n' + lang.database(prefix) , `${footer}`, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "ser premium","id": 'donar'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Sobre mí","id": 'infobot'}}] )
	break
case 'ownermenu':
	await yol.send5ButGif(from, `┌── *Info user*\n│» Nombre : ${pushname}\n│» Biografia : No detectada\n│» Numero : ${sender.split("@")[0]}\n│» Wa Api : http://wa.me/${sender.split("@")[0]}\n│» Usuario : ${isCreator ? `Owner ${ownername}` : isPremium ? `Usuario especial ${botname}` : `${botname}`}\n│» Estado : ${isCreator ? 'Owner ( ilimitado)' : isPremium ? 'Premium' : 'free'}\n│» Límite diario : ${isCreator ? 'Owner (ilimitado)' : isPremium ? 'Ilimitado' : (sender, limitharian)}\n│» Límite diario del juego : ${isCreator ? 'Owner (Ilimitado)' : (sender, limitgame)}\n└───────\n\n┌── *Info Bot*\n│» Biblioteca : Baileys Multi Device\n│» Nombre Bot : ${botname}\n│» Creador : ${ownername}\n│» Autor : DikaArdnt.\n│» Usuarios : ${Object.keys(global.db.data.users).length}\n└───────` + '\n' + lang.ownermenu(prefix) , `${footer}`, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "ser premium","id": 'donar'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Sobre mí","id": 'infobot'}}] )
	break
case 'voicemenu':
	await yol.send5ButGif(from, `┌── *Info user*\n│» Nombre : ${pushname}\n│» Biografia : No detectada\n│» Numero : ${sender.split("@")[0]}\n│» Wa Api : http://wa.me/${sender.split("@")[0]}\n│» Usuario : ${isCreator ? `Owner ${ownername}` : isPremium ? `Usuario especial ${botname}` : `${botname}`}\n│» Estado : ${isCreator ? 'Owner ( ilimitado)' : isPremium ? 'Premium' : 'free'}\n│» Límite diario : ${isCreator ? 'Owner (ilimitado)' : isPremium ? 'Ilimitado' : (sender, limitharian)}\n│» Límite diario del juego : ${isCreator ? 'Owner (Ilimitado)' : (sender, limitgame)}\n└───────\n\n┌── *Info Bot*\n│» Biblioteca : Baileys Multi Device\n│» Nombre Bot : ${botname}\n│» Creador : ${ownername}\n│» Autor : DikaArdnt.\n│» Usuarios : ${Object.keys(global.db.data.users).length}\n└───────` + '\n' + lang.voice(prefix) , `${footer}`, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "ser premium","id": 'donar'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Sobre mí","id": 'infobot'}}] )
	break
case 'creditos':
